...
namespace Treadmill
{
    internal static unsafe partial class TreadmillSDK
    {
        ...
        internal delegate void set_gait_data_callback_cb_delegate(uint timmstamp, bool left_foot, uint pattern, uint gait_duration);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void set_abnormal_event_callback_cb_delegate(uint timmstamp, uint event_type);
        ...
        internal static extern void set_abnormal_event_callback(set_abnormal_event_callback_cb_delegate cb);
